...
public class DepositoCTR {
    ...
    private DepositoDTO dto;
    private DepositoDAO dao;
      private FuncionarioINT daoFuncionario;
    private DepositoINT daodeposito;

    @GET
    public void saludoInicial() {
        System.out.println("Saludo desde REST TEST Deposito");
    }
...
//     dao.consultarTodos();
        ...
        return new Gson().toJson(daodeposito.consultarTodos());
    }
...
//     dao.consultarTodos();
        ...
        //new Gson().toJson(new PerfilDao().seleccionarTodos());
        return new Gson().toJson(daodeposito.consultarSegunID(Integer.parseInt(id)));
    }
